        ...
        if (currentStep instanceof responses_1.Response) {
            ...
            if (!_.isNull(this.multiScriptId)) {
                ...
                if (expectedUser !== parsedResponse.recipient) {
                    return _savedThis_1.rejectFunction[parsedResponse.recipient](new Error("Multi-script error failed got resposne for user '" + parsedResponse.recipient + "'  but expeccted response for user '" + expectedUser + "'"));
                }
            }
            else {
            ...
            this.promise[promiseId] = this.promise[promiseId].then(function () { return new Promise(function (resolve) {
                ...
                if (!_.isNull(_this.multiScriptId)) {
